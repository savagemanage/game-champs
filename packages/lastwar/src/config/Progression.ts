...
export const MISSIONS = {
  ...
  DAILY_TEMPLATES: [
    { id: 'build_1', nameKey: 'mission.daily.build', category: 'build', target: 1, points: 250, reward: { resources: { steel: 120 }, seasonXp: 20 } },
    { id: 'build_2', nameKey: 'mission.daily.buildMany', category: 'build', target: 3, points: 250, reward: { resources: { steel: 260 }, seasonXp: 40 } },
    { id: 'recruit_1', nameKey: 'mission.daily.recruit', category: 'recruit', target: 1, points: 250, reward: { shards: 10, seasonXp: 20 } },
    { id: 'recruit_2', nameKey: 'mission.daily.recruitMany', category: 'recruit', target: 5, points: 250, reward: { shards: 30, seasonXp: 45 } },
    { id: 'power_1', nameKey: 'mission.daily.powerUp', category: 'power_up', target: 2, points: 250, reward: { shards: 12, seasonXp: 25 } },
    { id: 'power_2', nameKey: 'mission.daily.powerUpMany', category: 'power_up', target: 6, points: 250, reward: { shards: 36, seasonXp: 50 } },
    { id: 'combat_1', nameKey: 'mission.daily.combat', category: 'combat', target: 2, points: 250, reward: { resources: { fuel: 120 }, seasonXp: 25 } },
    { id: 'combat_2', nameKey: 'mission.daily.combatMany', category: 'combat', target: 5, points: 250, reward: { resources: { fuel: 260 }, seasonXp: 55 } },
    { id: 'mini_1', nameKey: 'mission.daily.miniGame', category: 'mini_game', target: 1, points: 250, reward: { coins: 40, seasonXp: 20 } },
    { id: 'mini_2', nameKey: 'mission.daily.miniGameMany', category: 'mini_game', target: 3, points: 250, reward: { coins: 120, seasonXp: 45 } },
...
export const SEASON = {
  ...
  TIER_REWARDS: [
    ...
    { free: { resources: { steel: 600 } }, premium: { shards: 70 } },
    { free: { resources: { fuel: 400 } }, premium: { resources: { circuitry: 120 } } },
    { free: { shards: 30 }, premium: { coins: 180 } },
    { free: { resources: { rations: 700 } }, premium: { shards: 80 } },
    { free: { resources: { circuitry: 100 } }, premium: { shards: 100, coins: 200 } },
    { free: { resources: { steel: 800 } }, premium: { resources: { fuel: 600 } } },
    { free: { shards: 35 }, premium: { resources: { circuitry: 160 } } },
    { free: { coins: 120 }, premium: { shards: 110 } },
    { free: { resources: { fuel: 650 } }, premium: { resources: { steel: 900 } } },
    { free: { shards: 50 }, premium: { shards: 130, coins: 250 } },
    { free: { resources: { rations: 1000 } }, premium: { resources: { circuitry: 200 } } },
    { free: { resources: { steel: 1100 } }, premium: { shards: 150 } },
    { free: { shards: 60 }, premium: { resources: { fuel: 900 } } },
    { free: { coins: 180 }, premium: { shards: 170 } },
    { free: { resources: { circuitry: 180 } }, premium: { resources: { rations: 1500, steel: 1500 } } },
    { free: { resources: { fuel: 1000 } }, premium: { shards: 200 } },
    { free: { shards: 80 }, premium: { resources: { circuitry: 300 } } },
    { free: { coins: 250 }, premium: { shards: 240 } },
    { free: { resources: { rations: 1800, steel: 1800 } }, premium: { shards: 300, coins: 400 } },
    { free: { shards: 150, coins: 300 }, premium: { shards: 500, coins: 600, resources: { circuitry: 500 } } },
  ] as const,
} as const;
