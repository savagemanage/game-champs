 ...
 * language immediately. Reset clears the save through {@link MetaStore} and
 * returns to the Title with fresh progress.
 */
export class SettingsScene extends Phaser.Scene {
  ...
  private buildSlider(name: string, y: number, initial: number, onChange: (v: number) => void): void {
    ...
    this.add.rectangle(trackX, y, trackW, 8, PALETTE.ROAD_DARK).setOrigin(0, 0.5);
