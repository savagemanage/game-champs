...
>
> The workspace slug and GitHub Pages path (`packages/lastwar`,
> `savagemanage.github.io/open-games/lastwar/`) are only a **deployment
> identifier** and are not part of the game's brand. Nothing shipped in the
> build uses any third-party IP. The slug is a fixed deployment target and is
...
**Play the live build:** <https://savagemanage.github.io/open-games/lastwar/>
...
LAST SQUAD is a workspace of the [open-games](../../README.md) monorepo, so
...
LAST SQUAD is published as part of the [open-games](../../README.md) monorepo,
at <https://savagemanage.github.io/open-games/lastwar/>.
...
[`vite.config.ts`](vite.config.ts) (`/open-games/lastwar/`) is the only
game-side piece.
