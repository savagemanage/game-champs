...
| File | Name | Origin |
| --- | --- | --- |
| `favicon.png` | Browser-tab app mark — an ember flame glowing against a cold frost-dark rounded tile (16×16 pixel art exported at 32×32), matching the game's ember-in-the-cold motif; generated by [`tools/gen_sprites.py`](../tools/gen_sprites.py) (`build_favicon`) and referenced from `index.html` via a base-path-safe relative `<link rel="icon" href="./favicon.png">` | **Original** |
